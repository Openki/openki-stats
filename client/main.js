/*
 * This is the main entry point for the client side. It imports all code for the client.
 * The other files in the `/client` folder are also loaded without being referenced with `import`.
